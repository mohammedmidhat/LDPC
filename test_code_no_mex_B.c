...
void test_code_B(int iteration, int trials, double p_bsc, char *H_file, double *errors){
  srand(time(NULL));
...
void main(void){
	double *outMatrix;
	outMatrix = malloc(sizeof(double) * 2);
	test_code_B(30,1,0.01, "4095.737.3.txt", outMatrix);
}
