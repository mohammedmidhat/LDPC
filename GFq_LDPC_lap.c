...
void GFq_LDPC_lap(int iteration, int num_trials, double p, double *errors)
{
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    GFq_LDPC_lap(max_iter, num_trials, p, outMatrix);
}
